...
class ScoresAndFiltersApiTest {
	...
	void testLastVulnerabilities() throws ApiException {
		 VulnerabilityPage result = apiInstance.searchVulnerabilities(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
		 assertNotNull(result);
		 assertNotNull(result.getItems());
		 assertEquals(10, result.getItems().size());
		 
		 VulnerabilityPage scoreResult = apiInstance.searchVulnerabilities(BigDecimal.ZERO, BigDecimal.TEN, null, null, null, null, null, null, null, null, null, null, null, null, null);
		 assertNotNull(scoreResult);
		 assertNotNull(scoreResult.getItems());
		 assertEquals(10, scoreResult.getItems().size());
		 
		 VulnerabilityPage epssResult = apiInstance.searchVulnerabilities(null, null, BigDecimal.ZERO, BigDecimal.TEN, null, null, null, null, null, null, null, null, null, null, null);
		 ...
		 VulnerabilityPage dateResult = apiInstance.searchVulnerabilities(null, null, null, null, fromDate, toDate, null, null, null, null, null, null, null, null, null);
		 assertNotNull(dateResult);
		 assertNotNull(dateResult.getItems());
		 assertEquals(10, dateResult.getItems().size());

		 String product = ".NET 8.0";
		 VulnerabilityPage productResult = apiInstance.searchVulnerabilities(null, null, null, null, null, null, null, null, product, null, null, null, null, null, null);
		 assertNotNull(productResult);
		 assertNotNull(productResult.getItems());
		 assertEquals(10, productResult.getItems().size());

		 String vendor = "microsoft";
		 VulnerabilityPage vendorResult = apiInstance.searchVulnerabilities(null, null, null, null, null, null, null, null, null, vendor, null, null, null, null, null);
		 ...
		 VulnerabilityPage assignerResult = apiInstance.searchVulnerabilities(null, null, null, null, null, null, null, null, null, null, assigner, null, null, null, null);
		 assertNotNull(assignerResult);
		 assertNotNull(assignerResult.getItems());
		 assertEquals(10, assignerResult.getItems().size());
		 
		 VulnerabilityPage exploitedResult = apiInstance.searchVulnerabilities(null, null, null, null, null, null, null, null, null, null, null, Boolean.TRUE, null, null, null);
		 assertNotNull(exploitedResult);
		 assertNotNull(exploitedResult.getItems());
		 assertEquals(10, exploitedResult.getItems().size());
		 
		 VulnerabilityPage pageResult = apiInstance.searchVulnerabilities(null, null, null, null, null, null, null, null, null, null, null, null, Integer.valueOf(2), null, null);
		 assertNotNull(pageResult);
		 assertNotNull(pageResult.getItems());
		 assertEquals(10, pageResult.getItems().size());
		 
		 VulnerabilityPage sizeResult = apiInstance.searchVulnerabilities(null, null, null, null, null, null, null, null, null, null, null, null, null, null, Integer.valueOf(100));
